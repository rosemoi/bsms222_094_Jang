...
you receive an error because the variables `italy`, `cananda`, and `egypt`, are not defined. If we do not sue the quotes, R looks for variables with those names and returns an error.
